...
public class JaxrsApplicationAndResourcePackagesAnnotationScannerTest {
    ...
    private SpringMvcApplicationAndResourcePackagesAnnotationScanner scanner;

    @BeforeMethod
    public void setUp() {
        scanner = new SpringMvcApplicationAndResourcePackagesAnnotationScanner();
    }
    ...
    public void shouldScanOnlyResourcePackagesClasses() throws Exception {
        ...
        OpenApiContext ctx = new GenericOpenApiContext<>()
                ...
                .openApiScanner(new SpringMvcApplicationAndResourcePackagesAnnotationScanner().openApiConfiguration(config))
                .init();
