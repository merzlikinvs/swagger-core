...
import io.swagger.v3.springmvc.annotations.AbstractAnnotationTest;
import io.swagger.v3.springmvc.matchers.SerializationMatchers;
import io.swagger.v3.springmvc.petstore.EmptyPetResource;
import io.swagger.v3.springmvc.petstore.callback.ComplexCallbackResource;
import io.swagger.v3.springmvc.petstore.callback.MultipleCallbacksTestWithOperationResource;
import io.swagger.v3.springmvc.petstore.callback.RepeatableCallbackResource;
import io.swagger.v3.springmvc.petstore.callback.SimpleCallbackWithOperationResource;
import io.swagger.v3.springmvc.petstore.example.ExamplesResource;
import io.swagger.v3.springmvc.petstore.link.LinksResource;
import io.swagger.v3.springmvc.petstore.openapidefintion.OpenAPIDefinitionResource;
import io.swagger.v3.springmvc.petstore.operation.AnnotatedSameNameOperationResource;
import io.swagger.v3.springmvc.petstore.operation.ExternalDocumentationResource;
import io.swagger.v3.springmvc.petstore.operation.FullyAnnotatedOperationResource;
import io.swagger.v3.springmvc.petstore.operation.HiddenOperationResource;
import io.swagger.v3.springmvc.petstore.operation.NotAnnotatedSameNameOperationResource;
import io.swagger.v3.springmvc.petstore.operation.OperationResource;
import io.swagger.v3.springmvc.petstore.operation.OperationWithoutAnnotationResource;
import io.swagger.v3.springmvc.petstore.operation.ServerOperationResource;
import io.swagger.v3.springmvc.petstore.operation.SubResource;
import io.swagger.v3.springmvc.petstore.parameter.ArraySchemaResource;
import io.swagger.v3.springmvc.petstore.parameter.ComplexParameterResource;
import io.swagger.v3.springmvc.petstore.parameter.ComplexParameterWithOperationResource;
import io.swagger.v3.springmvc.petstore.parameter.MultipleNotAnnotatedParameter;
import io.swagger.v3.springmvc.petstore.parameter.OpenAPIJaxRSAnnotatedParameter;
import io.swagger.v3.springmvc.petstore.parameter.OpenAPIWithContentJaxRSAnnotatedParameter;
import io.swagger.v3.springmvc.petstore.parameter.OpenAPIWithImplementationJaxRSAnnotatedParameter;
import io.swagger.v3.springmvc.petstore.parameter.ParametersResource;
import io.swagger.v3.springmvc.petstore.parameter.RepeatableParametersResource;
import io.swagger.v3.springmvc.petstore.parameter.SingleJaxRSAnnotatedParameter;
import io.swagger.v3.springmvc.petstore.parameter.SingleNotAnnotatedParameter;
import io.swagger.v3.springmvc.petstore.requestbody.RequestBodyMethodPriorityResource;
import io.swagger.v3.springmvc.petstore.requestbody.RequestBodyParameterPriorityResource;
import io.swagger.v3.springmvc.petstore.requestbody.RequestBodyResource;
import io.swagger.v3.springmvc.petstore.responses.ComplexResponseResource;
import io.swagger.v3.springmvc.petstore.responses.ImplementationResponseResource;
import io.swagger.v3.springmvc.petstore.responses.MethodResponseResource;
import io.swagger.v3.springmvc.petstore.responses.NoImplementationResponseResource;
import io.swagger.v3.springmvc.petstore.responses.NoResponseResource;
import io.swagger.v3.springmvc.petstore.responses.OperationResponseResource;
import io.swagger.v3.springmvc.petstore.responses.PriorityResponseResource;
import io.swagger.v3.springmvc.petstore.security.SecurityResource;
import io.swagger.v3.springmvc.petstore.tags.CompleteTagResource;
import io.swagger.v3.springmvc.petstore.tags.TagClassResource;
import io.swagger.v3.springmvc.petstore.tags.TagMethodResource;
import io.swagger.v3.springmvc.petstore.tags.TagOpenAPIDefinitionResource;
import io.swagger.v3.springmvc.petstore.tags.TagOperationResource;
...
public class PetResourceTest extends AbstractAnnotationTest {
    ...
    private static final String PETSTORE_PACKAGE = "io.swagger.v3.springmvc.petstore";
