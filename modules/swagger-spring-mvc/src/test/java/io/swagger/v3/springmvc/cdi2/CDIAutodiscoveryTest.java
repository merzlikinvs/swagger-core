package io.swagger.v3.springmvc.cdi2;
...
import io.swagger.v3.springmvc.SwaggerSerializers;
import io.swagger.v3.springmvc.integration.resources.OpenApiResource;
...
public class CDIAutodiscoveryTest extends Arquillian {
    ...
    void confirmPathClassesWereDiscovered() {
        String[] expected = {
                "io.swagger.v3.springmvc.integration.resources.AcceptHeaderOpenApiResource",
                "io.swagger.v3.springmvc.integration.resources.OpenApiResource"
                };
    ...
    void confirmProviderClassesWereDiscovered() {
        String[] expected = {
                "io.swagger.v3.springmvc.SwaggerSerializers"
                };
